...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult getUserStats()
    {
        ...
        // 获取30天前的时间
        java.util.Calendar cal30DaysAgo = java.util.Calendar.getInstance();
        cal30DaysAgo.add(java.util.Calendar.DAY_OF_MONTH, -30);
        java.util.Date thirtyDaysAgo = cal30DaysAgo.getTime();
        ...
        for (SysUser u : allUsers) {
            ...
            // 统计VIP用户（remark包含"VIP"）
            if (StringUtils.isNotEmpty(u.getRemark()) && u.getRemark().contains("VIP")) {
                vipUsers++;
            }
            
            // 统计最近30天新增用户
            if (u.getCreateTime() != null && u.getCreateTime().after(thirtyDaysAgo)) {
                newUsers++;
            }
        }
